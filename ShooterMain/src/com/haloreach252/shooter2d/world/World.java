...
import com.haloreach252.shooter2d.collision.AABB;
import com.haloreach252.shooter2d.entity.Entity;
import com.haloreach252.shooter2d.entity.Player;
import com.haloreach252.shooter2d.entity.Transform;
...
public class World {
	...
	public void correctCamera(Camera camera, Window window) {
		...
		if(pos.x < w + (window.getWidth() / 2) + scale) pos.y = w + (window.getWidth() / 2) + scale;
